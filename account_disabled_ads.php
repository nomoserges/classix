    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 page-content">
                <h2 class="title-2"> Annonces désactivées</h2>
                    ...
                    <table class="table table-striped table-bordered add-manage-table">
                        ...
                        <?php for($i=0; $i < sizeof($listeAnnonces); $i++): ?>
                            <tr>
                                ...
                                <td class="action-td">
                                    <p><a href="<?php echo $_SERVER['PHP_SELF']; ?>?action=enable&id=<?php echo $listeAnnonces[$i]["idadvert"]; ?>"
                                          class="btn btn-info btn-xs">Activer</a></p>
